...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        ...
        {img:"foto/носки.webp", name:"без комментариев", price:"200rub", butText:"В КОРЗИНУ"},
        {img:"foto/чехол Iphone 13.jpg", name:"все будет гуд", price:"200rub", butText:"В КОРЗИНУ"},
        {img:"foto/носки.webp", name:"штраф за тонировку ", price:"200rub", butText:"В КОРЗИНУ"}];
